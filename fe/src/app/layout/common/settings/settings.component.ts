...
import { SchemeService } from 'app/core/scheme/scheme.service';
...
export class SettingsComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._fuseConfigService.config$
            ...
            .subscribe((config: FuseConfig) =>
            {
                // Store the config
                this.config = config;
                this.scheme = this._schemeService.getScheme(); // Cập nhật scheme hiện tại
    ...
    {
        this._schemeService.setScheme(scheme);
