...
export class NewsDetailComponent implements OnInit {
        ...
        try {
            ...
            if (!file.type.startsWith('image/')) {
                this._alertService.showAlert({
                    ...
                    message: this._translocoService.translate('news.error_image_format'),
                    type: 'error'
                });
                return;
            }
            ...
            this._alertService.showAlert({
                title: this._translocoService.translate('other.error_title'),
                message: this._translocoService.translate('news.error_image_upload'),
                type: 'error'
            });
        }
    }
    ...
    insertImage() {
        ...
        if (this.imageUrl) {
            ...
            this._alertService.showAlert({
                ...
                message: this._translocoService.translate('news.success_image_insert'),
                type: 'success'
            });
        }
    }
    ...
    submitUpdateNews() {
        ...
        this._newsService.updateNews(this.news?.id, this.news).subscribe(
            (news) => {
                this._alertService.showAlert({
                    title: this._translocoService.translate('news.success_title'),
                    message: this._translocoService.translate('news.success_update_message'),
                    type: 'success'
                });
            ...
            (error) => {
                ...
                if (error?.error?.code === 'VALIDATION_ERROR' && Array.isArray(error.error.errors)) {
                    ...
                    this._alertService.showAlert({
                        title: this._translocoService.translate('other.error_title'),
                        message: this._translocoService.translate('errors.default'),
                        type: 'error'
                    });
                }
            }
    ...
    deleteNews() {
        this._newsService.deleteNews(this.news?.id).subscribe(
            (news) => {
                this._alertService.showAlert({
                    title: this._translocoService.translate('news.success_title'),
                    message: this._translocoService.translate('news.success_delete_message'),
                    type: 'success'
                });
            ...
            (error) => {
                ...
                this._alertService.showAlert({
                    title: this._translocoService.translate('news.error_title'),
                    message: this._translocoService.translate('news.error_delete_message'),
                    type: 'error'
                });
            }
        );
