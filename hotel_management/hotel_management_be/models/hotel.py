...
class Hotel(BaseModel):
    ...
    uuid = ShortUUIDField(primary_key=True, unique=True, max_length=20, length=10, alphabet="abcdefghjklmnopqrstuvwxyz")
    status = models.CharField(choices=HotelConstants.HOTEL_STATUS, null=True,blank=True, max_length=10, default="Active")
    ...
    # rating
    destination = models.ForeignKey(Destination, on_delete=models.SET_NULL, related_name='destination', null=True)
...
class RoomType(BaseModel):
    ...
    size = models.CharField(null=True, blank=True , max_length=50, default='0')
